    ...
    <main>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col p-5 max-w-2xl mx-auto mb-10' >
                    ...
                    <label className='block mb-5'>
                        ...
                        <textarea 
                            ...
                            className='shadow border rounded py-2 px-3 form-textarea mt-1 block w-full focus:outline-none focus:ring ring-primary' placeholder='Comment' rows={8}/>
                    </label>
        ...
        {/* <div className='flex flex-col p-10 my-10 max-w-2xl mx-auto shadow-yellow-500 shadow space-y-2'>
            ...
            {post.comments.map((comment) => (
                <div key={comment._id}>
                    <p className='border-2 border-orange-100 rounded-lg p-4'>
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
    const query =  `*[_type == "post" && slug.current == $slug][0] {
      ...
      return {
          ...
          revalidate: 3600, //after 60s, it will update the old cached version
      };
};